...
if __name__ == "__main__":
    assert title_key("ايسنا") == title_key("ایسنا"), "Arabic/Persian YEH must fold"
    ...
    assert content_hash("a", "b", "c") == content_hash("a", "b", "c") != content_hash("a", "b", "d")
    assert parse_iso("2026-01-01T00:00:00Z") is not None and parse_iso("nope") is None
    print("text: all checks passed")
