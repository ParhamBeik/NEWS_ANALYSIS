#!/usr/bin/env python3
"""
TEST VERSION: Scheduled-loop monitoring pipeline with NEW PROMPTS.
Runs continuously and outputs to TEST_OUTPUT directory for comparison with production.
...
4. Runs in continuous loop mode
"""
...
if __name__ == "__main__":
    try:
        run_loop_mode(LOOP_INTERVAL_MINUTES)
    except KeyboardInterrupt:
